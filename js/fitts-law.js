...
var testDimension = makeDimension(820, 600, 30, 30, 30, 30);
...
var randomizeInput = [[400, 50],[250,50], [200,100], [250, 100], [400, 100]];
var counter = 0;
...
var fittsTest = {
	...
	mouseClicked: function(x, y) {
		...
		if (checkTime == 0) {
			...
			getTime.push(nowTime - checkTime);
		}
		checkTime = nowTime;
	...
	randomizeParams: function() {
		...
		this.isoParams.distance = randomizeInput[counter][0];
		this.isoParams.width = randomizeInput[counter][1];
		counter++;
